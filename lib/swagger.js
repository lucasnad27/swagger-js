...
(function () {
  ...
  SwaggerResource.prototype.addApiDeclaration = function (response) {
    ...
    if (response.apiSummary)
      this.apiSummary = response.apiSummary;
  ...
  SwaggerResource.prototype.addOperations = function (resource_path, ops, consumes, produces) {
    if (ops) {
      ...
      for (var i = 0; i < ops.length; i++) {
        ...
        var op = new SwaggerOperation(o.nickname, resource_path, method, o.parameters, o.summary, o.notes, type, responseMessages, this, consumes, produces, o.authorizations, o.scopes, o.deprecated);
  ...
  var SwaggerOperation = function (nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces, authorizations, scopes, deprecated) {
    var _this = this;
